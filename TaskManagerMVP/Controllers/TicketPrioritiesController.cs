...
namespace TaskManagerMVP.Controllers
{
    ...
    public class TicketPrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ticketPriority = await _context.Priorities
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,IsActive")] TicketPriority ticketPriority)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ticketPriority = await _context.Priorities.FindAsync(id);
            if (ticketPriority == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsActive")] TicketPriority ticketPriority)
        {
        ...
        {
            var ticketPriority = await _context.Priorities.FindAsync(id);
            _context.Priorities.Remove(ticketPriority);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
