...
namespace TaskManagerMVP.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ticketStatus = await _context.Statuses
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,IsActive")] TicketStatus ticketStatus)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ticketStatus = await _context.Statuses.FindAsync(id);
            if (ticketStatus == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsActive")] TicketStatus ticketStatus)
        {
        ...
        {
            var ticketStatus = await _context.Statuses.FindAsync(id);
            _context.Statuses.Remove(ticketStatus);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
